    ...
    return(
        <View style={{flex:1}}>
           ...
           <View style={{height:height*0.38,backgroundColor:'white',borderBottomEndRadius:50,borderBottomLeftRadius:50}}>
            <Text style={{fontSize:height*0.06,marginTop:height*0.07,marginLeft:'10%',color:'#540840',fontFamily:'Kanit_Bold'}}>Last Thing</Text>
               ...
               <TouchableOpacity onPress={()=>navigation.goBack()}>
                 ...
                 <Text style={{marginTop:height*0.02,marginLeft:"10%",fontSize:width*0.04}}>Facere dolor animi nescuint quo quo</Text>
                 ...
                 <Text style={{marginLeft:width*0.85,marginTop:height*-0.08,fontSize:height*0.035,color:"#821558",fontFamily:"Nunito_Bold"}}>0/5</Text>
