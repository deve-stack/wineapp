...
const TopicInfo2=({navigation})=>{
    return(
        <ScrollView>
        <View style={{flex:1}}>
           
          <Image source={assets.beef1} style={{height:height*0.35,width:width*1}}/>
             ...
             <TouchableOpacity onPress={()=>navigation.goBack() }>
                ...
                <Text style={{color:"white",fontFamily:"Nunito_ExtraBold",fontSize:width*0.05}}>Pairings: Beef</Text>
             ...
             <View style={{height:height*0.32,width:width*0.86,marginLeft:width*0.07,backgroundColor:"white",borderRadius:25,marginTop:height*0.12,elevation:5}}>
                <View style={{marginHorizontal:width*0.05}}>
                    <Text style={{fontSize:width*0.037,marginTop:height*0.02}}>Beef nisi et desurent il aut. Repudiandea</Text>
             ...
             <Image source={assets.Pairing_beef} style={{height:height*0.22,width:width*1,marginTop:height*0.05}}/>
             <Text style={{marginLeft:width*0.07,color:"#8c085a",fontFamily:"Nunito_Black",marginTop:height*0.05}}>Top Wines</Text>
             <View>
